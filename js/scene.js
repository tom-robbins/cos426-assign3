...
Scene.getIntersectFunction = function() {
    ...
    for (var i = 0; i < sceneData.objects.length; i++) {
        ...
        matStr += "Material material" + i + " = Material(" +
                  Raytracer[m.type] + ", " +
        ...
        switch (obj.type) {
            case "sphere":
                funcStr += "cur_dist = findIntersectionWithSphere(ray, " +
            ...
            case "plane":
                funcStr += "cur_dist = findIntersectionWithPlane(ray, " +
            ...
            case "cylinder":
                funcStr += "cur_dist = findIntersectionWithCylinder(ray, " +
            ...
            case "cone":
                funcStr += "cur_dist = findIntersectionWithCone(ray, " +
                        arrayToVec3String(obj.bottomCenter) + ", " +
                        arrayToVec3String(obj.topCenter) + ", " +
                        obj.radius.toFixed(2) + ", " +
                        "intersect);\n";
            ...
            case "box":
                funcStr += "cur_dist = findIntersectionWithBox(ray, " +
            ...
            case "triangle":
                funcStr += "cur_dist = findIntersectionWithTriangle(ray, " +
